...
# python custom_inference.py --dataset aumc --model_type istrats --hid_dim 64 --num_layers 2 --num_heads 16 --dropout 0.2 --attention_dropout 0.2 --lr 5e-5 --load_ckpt_path ../outputs/aumc/pretrain/checkpoint_best.bin --model_ckpt_path ../outputs/aumc/istrats_final/checkpoint_best.bin --split infer --batch_size 16 --output_dir ../outputs/aumc/istrats_final
# python custom_inference.py --dataset aumc-4 --model_type istrats --hid_dim 64 --num_layers 2 --num_heads 16 --dropout 0.2 --attention_dropout 0.2 --lr 5e-5 --load_ckpt_path ../outputs/aumc/pretrain/checkpoint_best.bin --model_ckpt_path ../outputs/aumc/istrats_final/checkpoint_best.bin --split infer --batch_size 16 --output_dir ../outputs/aumc/istrats_final
# python custom_inference.py --dataset aumc-8 --model_type istrats --hid_dim 64 --num_layers 2 --num_heads 16 --dropout 0.2 --attention_dropout 0.2 --lr 5e-5 --load_ckpt_path ../outputs/aumc/pretrain/checkpoint_best.bin --model_ckpt_path ../outputs/aumc/istrats_final/checkpoint_best.bin --split infer --batch_size 16 --output_dir ../outputs/aumc/istrats_final
# python custom_inference.py --dataset aumc-12 --model_type istrats --hid_dim 64 --num_layers 2 --num_heads 16 --dropout 0.2 --attention_dropout 0.2 --lr 5e-5 --load_ckpt_path ../outputs/aumc/pretrain/checkpoint_best.bin --model_ckpt_path ../outputs/aumc/istrats_final/checkpoint_best.bin --split infer --batch_size 16 --output_dir ../outputs/aumc/istrats_final
...
# python main.py --pretrain 1 --dataset aumc --model_type iistrats --hid_dim 64 --num_layers 2 --num_heads 16 --dropout 0.2 --attention_dropout 0.2 --lr 5e-4 --max_epochs 100 --train_batch_size 8
# template="python main.py --dataset aumc --model_type iistrats --hid_dim 64 --num_layers 2 --num_heads 16 --dropout 0.2 --attention_dropout 0.2 --lr 5e-5 --train_batch_size 8 --load_ckpt_path ../outputs/aumc/pretrain/checkpoint_best.bin"
